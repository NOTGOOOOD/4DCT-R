    ...
    with torch.no_grad():
        ...
        for batch, (moving, fixed, img_name) in enumerate(test_loader_patient):
            ...
            if is_save:
                ...
                save_image(torch.permute(y_pred[1][0], (1, 2, 3, 0)), args.output_dir,
                           m2f_name)
                ...
                save_image(y_pred[0], args.output_dir, m_name)
...
if __name__ == '__main__':
    ...
    if args.checkpoint_name is not None:
        ...
        test_dirlab(args, model, test_loader_dirlab, is_train=False, is_save=False, suffix='vm', calc_tre=False)
